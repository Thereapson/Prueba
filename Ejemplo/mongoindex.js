...
// config
const app = express()
const port = process.env.PORT //3001 - 3005 del localhost
const db = process.env.MONGODB_URI // mongodb+srv://Thereapson:<password>@cluster0.wo0lbwv.mongodb.net/?retryWrites=true&w=majority
